...
const products = [
  {
    ...
    brand: Mirage,
    Image: Aire3,
    infoProduct: "Mayor rapidez de enfriamiento, Refrigerante R410 ecológico, Uso eficiente de la potencia, Menor consumo de energía, Ambiente silencioso",
  },
  {
    id: 2,
    ...
    brand: Mirage,
    Image: Aire2,
    infoProduct: "Core en compresor Doble escala de temperatura, Smart swing, High memory Refrigerante R22",
  },
  {
    id: 3,
    ...
    brand: Mirage,
    Image: Aire4,
    infoProduct: "Mayor rapidez de enfriamiento, Refrigerante R410 ecológico, Uso eficiente de la potencia, Menor consumo de energí, Ambiente silencioso",
  },
  {
    id: 4,
    title: "4MC(W)W15",
    brand: Trane,
    Image: Aire5,
    infoProduct: "Sistema de eficiencia estándar (hasta 12.9 seer), 60 hz, High Wall, R-410, de 12 a 36 MBH., 5 velocidades: baja, media, alta, turbo y “mute”, Función I-Feel, Mejor distribución de aire con auto-swing y smart air flow, Temporizador, Re-arranque automático, Funciones “eco” y “sleep”, Bajo ruido, Auto-diagnóstico",
  },
  {
    id: 5,
    title: "4MXW16",
  ...
  },
  {
    ...
    brand: Duventus,
    Image: Aire8,
    infoProduct: "Mini Split tradicional con alta eficiencia enfocada en el ahorro y el cuidado del medio ambiente con el gas ecológico R410 A. “Creado para maximizar tú confort.”",
  },
];
